...
/*
Package grpc_gateway_greeter is a reverse proxy.

It translates gRPC into RESTful JSON APIs.
*/
package grpc_gateway_greeter
...
var (
	pattern_Greeter_Hello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"greeter", "hello"}, "", runtime.AssumeColonVerbOpt(true)))
)
